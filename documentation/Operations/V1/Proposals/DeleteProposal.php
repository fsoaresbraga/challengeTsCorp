...
#[OA\Delete(
    ...
    description: 'Soft delete a proposal in DRAFT or SUBMITTED status with optimistic lock (RF-09).',
    tags: ['Proposals'],
    parameters: [
        new OA\Parameter(
            name: 'id',
    ...
    responses: [
        new OA\Response(response: 204, description: 'Proposal soft deleted'),
        new OA\Response(
            response: 404,
